    ...
    Ctx const& ctx )
{
    ...
    to_described_member<Ctx, T> member_converter{res, *obj, ctx, 0u};
    ...
    if( member_converter.BJIntrusive_Count != obj->size() )
    {
        ...
        BOOST_MESSAGE(fmt::format("Converted {} element out of {} in the json, while processing obj {} in {}", member_converter.BJIntrusive_Count,obj->size(), getTypeName<T>(), BJIntrusive::composePath()))
        return res;
    }
