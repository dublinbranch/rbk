 ...
 * @param the name that will be used inside the sqlColumn
 * @param fcgi status
 * @param search pattern
 * @return
 */
std::string search(DB* db, const QStringAdt& httpKey, std::string_view sqlColumn, PMFCGI& status, SearchPattern pattern = SearchPattern::START);
