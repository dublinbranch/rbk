...
BOOST_DESCRIBE_STRUCT(BeastConf, (), (staticFile, staticFileCacheTTL, htmlAllException, logFolder, worker, address, port, logRequest, maxResponseSize, logResponse, logRequestByIp, logWhitelist, logBlacklist))
